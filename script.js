...
function updatePageSizeRule(template) {
  ...
  // A page cut to the label, at true size, one label per page — which is what a
  // PDF from the label printer's own software looks like (a T12*40 job is 14
  // pages of 40.05 x 12.02mm). Nothing is scaled to fit a sheet: the tape is the
  // page. If the output arrives letterboxed on Letter instead, it is the print
  // dialog overriding this — see the printing notes in the README.
